...
def run(configNum):
    # configNum = None
    # 使用给定配置运行spark
    run_cmd = '/usr/local/home/zwr/wordcount-100G-ga.sh ' + str(configNum) + ' /usr/local/home/yyq/bo/lhs_bo/config/wordcount-100G'
    os.system(run_cmd)
...
def draw_target(bo):
    ...
    plt.ylabel('runtime')
    plt.legend()
    plt.savefig("/usr/local/home/yyq/bo/lhs_bo/lhs_target.png")
    plt.show()
