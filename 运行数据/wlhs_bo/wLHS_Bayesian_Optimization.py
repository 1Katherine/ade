...
# 保存配置
generation_confs = "/usr/local/home/yyq/bo/wlhs_bo/generationConf.csv"
...
def run(configNum):
    # configNum = None
    # 使用给定配置运行spark
    run_cmd = '/usr/local/home/zwr/wordcount-100G-ga.sh ' + str(configNum) + ' /usr/local/home/yyq/bo/wlhs_bo/config/wordcount-100G'
    os.system(run_cmd)
