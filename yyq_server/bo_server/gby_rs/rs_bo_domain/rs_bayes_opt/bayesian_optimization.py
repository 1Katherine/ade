...
class BayesianOptimization(Observable):
    ...
    def maximize(self,
        ...
        print('迭代结束条件，当执行时间低于Tmax时，停止搜索，此时对应优化倍数为7倍。Tmax = ' + str(Tmax))
        ...
        while not self._queue.empty or iteration < n_iter:
            ...
            print('x = ' + str(x))
            predict_target = self._gp.predict([x],return_std=True)
            print('interations = ' + str(iteration) + '， x_probe predict_target = ' + str(predict_target))
