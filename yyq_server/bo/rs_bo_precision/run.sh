...
# $1 = wordcount-100G
echo "=============== start $1 ===============" >> direct_rs_pre_bayesian.log
echo $(date) >> direct_rs_pre_bayesian.log
echo "=============== start $1 ===============" >> direct_rs_pre_bayesian.log
...
mv /usr/local/home/yyq/bo/rs_bo_precision/rs_pre_target* /usr/local/home/yyq/bo/rs_bo_precision/config/$1-$startTime
...
echo "=============== finish $1 ===============" >> direct_rs_pre_bayesian.log
echo $(date) >> direct_rs_pre_bayesian.log
echo "=============== finish $1 ===============" >> direct_rs_pre_bayesian.log
