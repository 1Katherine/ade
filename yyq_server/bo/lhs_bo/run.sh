...
# $1 = wordcount-100G
echo "=============== start $1 ===============" >> direct_lhs_Bayesian.log
echo $(date) >> direct_lhs_Bayesian.log
echo "=============== start $1 ===============" >> direct_lhs_Bayesian.log
...
mv /usr/local/home/yyq/bo/lhs_bo/wlhs_target* /usr/local/home/yyq/bo/lhs_bo/config/$1-$startTime

mkdir -p /usr/local/home/yyq/bo/lhs_bo/config/wordcount-100G
python3 direct_lhs_Bayesian.py
...
echo "=============== finish $1 ===============" >> direct_lhs_Bayesian.log
echo $(date) >> direct_lhs_Bayesian.log
echo "=============== finish $1 ===============" >> direct_lhs_Bayesian.log
