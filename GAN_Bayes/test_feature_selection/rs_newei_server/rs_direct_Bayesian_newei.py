...
# 重要参数
vital_params_path = "/usr/local/home/yyq/bo/rs_bo/rs_bo_newEI/parameters_set_84.txt"
# 维护的参数-范围表
# conf_range_table = "/usr/local/home/yyq/bo/rs_bo/rs_bo_newEI/Spark_conf_range_"  + opts.benchmark.split('-')[0] +  ".xlsx"
conf_range_table = "/usr/local/home/yyq/bo/rs_bo/rs_bo_newEI/Spark_conf_range.xlsx"
# 保存配置
